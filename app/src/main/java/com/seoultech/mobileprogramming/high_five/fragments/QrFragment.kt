...
import com.seoultech.mobileprogramming.high_five.databinding.FragmentHighFiveBinding
 ...
 * Use the [HighFiveFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class HighFiveFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        var binding = FragmentHighFiveBinding.inflate(layoutInflater)
        ...
        // renders the QR code as a native image
        val userQRCodeImage =
            QRCode(
                userInfo,
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(param1: String, param2: String) = HighFiveFragment().apply {
